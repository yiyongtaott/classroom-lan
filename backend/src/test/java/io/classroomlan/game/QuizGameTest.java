...
class QuizGameTest {
    ...
    void testCannotAnswerAfterTimeOut() {
        ...
        QuizGame.GameActionResult result = game.handleAction("player1", "ANSWER", Map.of("answer", 0));
        assertEquals(QuizGame.GameActionResult.Type.ERROR, result.type);
    ...
    void testDuplicateAnswerRejected() {
        ...
        QuizGame.GameActionResult second = game.handleAction("player1", "ANSWER", Map.of("answer", 1));

        assertEquals(QuizGame.GameActionResult.Type.ERROR, second.type);
